...
import com.example.password.databinding.ActivityRegisterBinding;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = new Intent(RegisterActivity.this, InterProcess.class);
        startService(intent);


        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_reg);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_contact) {
            Intent intent1 = new Intent(RegisterActivity.this, ContactActivity.class);
